<?php
    function getCategoryByStoreID($select, $store, $timeFrom, $timeTo){
    ...
    if( !isset($aResult['error']) ) {
        ...
        switch($_POST['functionname']) {
            ...
            if( !is_array($_POST['arguments']) ) {
                ...
                $aResult['result'] = getCategoryByStoreID($_POST['arguments'][0], $_POST['arguments'][1], $_POST['arguments'][2], $_POST['arguments'][3]);
            }
            break;
...
echo json_encode(getCategoryByStoreID('銷售額', 9, '2018-01-01', '2018-02-01'));
